    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="user_id" name="user_id" type="text" class="mt-1 block w-full"
                :value="old('user_id', $user->user_id)" required autocomplete="username" />
        ...
        <div>
            ...
            <textarea id="bio" name="bio" rows="4" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-200">{{ old('bio', $user->bio) }}</textarea>
